...
public function get_festivals(){
	...
	public function get_total_population(){
		// $this->db->select('sum(case when mamber_name != "" then 1 else 0 end) as gross_pop,
		// 	sum(case when member_gender like "%महिला%" then 1 else 0 end) as fem_pop,
		// 	sum(case when member_gender like "%पुरुष%" then 1 else 0 end) as mal_pop
		// 	');

		$this->db->select('count(mamber_name) as gross_pop,sum(case when member_gender like "%महिला%" then 1 else 0 end) as fem_pop,sum(case when member_gender like "%पुरुष%" then 1 else 0 end) as mal_pop');
		$this->db->distinct();
	...
	public function get_family_number(){
		$this->db->select('count(household_name),
			');
		$this->db->distinct();
	...
	public function get_population_by_agegroup_category($rm =null){
		$this->db->select('sum(case when household_gender = "पुरुष" and household_age <= 5 then 1 else 0 end) as male_5,
			sum(case when household_gender = "महिला" and household_age <= 5 then 1 else 0 end) as female_5,
			sum(case when household_gender = "तेश्रो लिङ्गी" and household_age <= 5 then 1 else 0 end) as others_5,

			sum(case when household_gender = "पुरुष" and household_age between 5 and 9 then 1 else 0 end) as male_5_9,
			sum(case when household_gender = "महिला" and household_age between 5 and 9 then 1 else 0 end) as female_5_9,
			sum(case when household_gender = "तेश्रो लिङ्गी" and household_age between 5 and 9 then 1 else 0 end) as others_5_9,

			sum(case when household_gender = "पुरुष" and household_age between 10 and 14 then 1 else 0 end) as male_10_14,
			sum(case when household_gender = "महिला" and household_age between 10 and 14 then 1 else 0 end) as female_10_14,
			sum(case when household_gender = "तेश्रो लिङ्गी" and household_age between 10 and 14 then 1 else 0 end) as others_10_14,

			sum(case when household_gender = "पुरुष" and household_age between 15 and 18 then 1 else 0 end) as male_18,
			sum(case when household_gender = "महिला" and household_age between 15 and 18 then 1 else 0 end) as female_18,
			sum(case when household_gender = "तेश्रो लिङ्गी" and household_age between 15 and 18 then 1 else 0 end) as others_18,

			sum(case when household_gender = "पुरुष" and household_age between 19 and 24 then 1 else 0 end) as male_24,
			sum(case when household_gender = "महिला" and household_age between 19 and 24 then 1 else 0 end) as female_24,
			sum(case when household_gender = "तेश्रो लिङ्गी" and household_age between 19 and 24 then 1 else 0 end) as others_24,

			sum(case when household_gender = "पुरुष" and household_age between 25 and 45 then 1 else 0 end) as male_45,
			sum(case when household_gender = "महिला" and household_age between 25 and 45 then 1 else 0 end) as female_45,
			sum(case when household_gender = "तेश्रो लिङ्गी" and household_age between 25 and 45 then 1 else 0 end) as others_45,

			sum(case when household_gender = "पुरुष" and household_age between 46 and 59 then 1 else 0 end) as male_59,
			sum(case when household_gender = "महिला" and household_age between 46 and 59 then 1 else 0 end) as female_59,
			sum(case when household_gender = "तेश्रो लिङ्गी" and household_age between 46 and 59 then 1 else 0 end) as others_59,

			sum(case when household_gender = "पुरुष" and household_age between 60 and 69 then 1 else 0 end) as male_69,
			sum(case when household_gender = "महिला" and household_age between 60 and 69 then 1 else 0 end) as female_69,
			sum(case when household_gender = "तेश्रो लिङ्गी" and household_age between 60 and 69 then 1 else 0 end) as others_69,

			sum(case when household_gender = "पुरुष" and household_age >= 70 then 1 else 0 end) as male_plus,
			sum(case when household_gender = "महिला" and household_age >= 70 then 1 else 0 end) as female_plus,
			sum(case when household_gender = "अन्य" >= 70 then 1 else 0 end) as others_plus,
			');
		$this->db->from('household_statistics_form');
		$query = $this->db->get();
		return $query->result_array();	
...
// 11 ends here
	...
	public function get_population_by_member_age_wise(){
		$this->db->select('dob, member_gender, mamber_name');
		$this->db->from('member_info');
		$query = $this->db->get();
		return $query->result_array();
	}
	...
	public function get_population_by_mothertongue(){
		$this->db->select('sum(case when mother_tongue like "%नेपाली%" then 1 else 0 end) as nepali,
			sum(case when mother_tongue like "%डोटेली/बझाँगी%" then 1 else 0 end) as doteli,
			sum(case when mother_tongue like "%थारु%" then 1 else 0 end) as tharu,
			sum(case when mother_tongue like "%मगर%" then 1 else 0 end) as magar,
			sum(case when mother_tongue like "%भोटे लामा%" then 1 else 0 end) as lama,
			sum(case when mother_tongue like "गुरुग तमु" then 1 else 0 end) as gurung,
			sum(case when mother_tongue like "%तामांग%" then 1 else 0 end) as tamang,
			sum(case when mother_tongue like "%अन्य%" then 1 else 0 end) as others,
	...
	public function get_population_by_religion(){
		$this->db->select('sum(case when classify_basis_of_religion like "%हिन्दू%" then 1 else 0 end) as hindu,
			sum(case when classify_basis_of_religion like "%बौद्द%" then 1 else 0 end) as buddha,
			sum(case when classify_basis_of_religion like "%इस्लाम%" then 1 else 0 end) as islam,
			sum(case when classify_basis_of_religion like "%क्रिश्चियन%" then 1 else 0 end) as christian,
			sum(case when classify_basis_of_religion like "%किराँत%" then 1 else 0 end) as kirat,
			sum(case when classify_basis_of_religion like "%शिख%" then 1 else 0 end) as shikh,
			sum(case when classify_basis_of_religion like "%अन्य%" then 1 else 0 end) as others,
			sum(case when classify_basis_of_religion != "" then 1 else 0 end) as tot');
		$this->db->from('household_statistics_form');
		$query = $this->db->get();
		return $query->result_array();	
	}
	...
	public function get_population_by_caste(){
		$this->db->select('sum(case when classify_basis_of_caste = "व्राम्हण" then 1 else 0 end) as brahmin,
			sum(case when classify_basis_of_caste = "क्षेत्री" then 1 else 0 end) as chhetri,
			sum(case when classify_basis_of_caste = "नेवार" then 1 else 0 end) as newar,
			sum(case when classify_basis_of_caste = "ठकुरी" then 1 else 0 end) as thakuri,
			sum(case when classify_basis_of_caste = "अादिवासी जनजाती" then 1 else 0 end) as janajati,
			sum(case when classify_basis_of_caste = "सार्की/कामी" then 1 else 0 end) as kami,
			sum(case when classify_basis_of_caste = "गुरुङ" then 1 else 0 end) as gurung,
			sum(case when classify_basis_of_caste = "मगर" then 1 else 0 end) as magar,
			sum(case when classify_basis_of_caste = "दलित" then 1 else 0 end) as dalit,
			sum(case when classify_basis_of_caste = "राई/लिम्बु" then 1 else 0 end) as rai,
			sum(case when classify_basis_of_caste = "थारु" then 1 else 0 end) as tharu,
			sum(case when classify_basis_of_caste = "यादव" then 1 else 0 end) as yadav,
			sum(case when classify_basis_of_caste = "घर्ति" then 1 else 0 end) as gharti,
			sum(case when classify_basis_of_caste = "दमाई" then 1 else 0 end) as damai,
			sum(case when classify_basis_of_caste = "कुमाल" then 1 else 0 end) as kumal,
			sum(case when classify_basis_of_caste = "अन्य" then 1 else 0 end) as others,
			sum(case when classify_basis_of_caste != "" then 1 else 0 end) as tot');
		$this->db->from('household_statistics_form');
		$query = $this->db->get();
		return $query->result_array();	
	}
	...
	public function get_population_by_gender_agegroup(){
		...
		$this->db->select('
			sum(case when member_gender = "पुरुष" and disabled = "छ" then 1 else 0 end) as tot_dis_male,
			sum(case when member_gender = "महिला" and disabled = "छ" then 1 else 0 end) as tot_dis_female,
			sum(case when member_gender = "पुरुष" and disabled = "छ" and disabled_type = "पूर्ण अपाङ्गता (रातो)" then 1 else 0 end) as red_dis_male,
			sum(case when member_gender = "महिला" and disabled = "छ" and disabled_type = "पूर्ण अपाङ्गता (रातो)" then 1 else 0 end) as red_dis_female,
			sum(case when member_gender = "पुरुष" and disabled = "छ" and disabled_type = "अति अशक्त (निलो)" then 1 else 0 end) as blue_dis_male,
			sum(case when member_gender = "महिला" and disabled = "छ" and disabled_type = "अति अशक्त (निलो)" then 1 else 0 end) as blue_dis_female,
			sum(case when member_gender = "पुरुष" and disabled = "छ" and disabled_type = "मध्यम अपाङ्गता (पहेलो)" then 1 else 0 end) as yell_dis_male,
			sum(case when member_gender = "महिला" and disabled = "छ" and disabled_type = "मध्यम अपाङ्गता (पहेलो)" then 1 else 0 end) as yell_dis_female,
			sum(case when member_gender = "पुरुष" and disabled = "छ" and disabled_type = "सामान्य अपाङ्गता (सेतो)" then 1 else 0 end) as white_dis_male,
			sum(case when member_gender = "महिला" and disabled = "छ" and disabled_type = "सामान्य अपाङ्गता (सेतो)" then 1 else 0 end) as white_dis_female
		');
		$this->db->from('member_info');
		$query = $this->db->get();
		return $query->result_array();	
	...
	public function child_disability_population(){
		$this->db->select('
			sum(case when member_gender = "पुरुष" and disabled_parichaya = "छ" and disabled_type = "सामान्य अपाङ्गता (सेतो)" then 1 else 0 end) as whi_dis_male,
			sum(case when member_gender = "पुरुष" and disabled_parichaya = "छ" and disabled_type = "मध्यम अपाङ्गता (पहेलो)" then 1 else 0 end) as yell_dis_male,
			sum(case when member_gender = "पुरुष" and disabled_parichaya = "छ" and disabled_type = "अति अशक्त (निलो)" then 1 else 0 end) as blue_dis_male,
			sum(case when member_gender = "पुरुष" and disabled_parichaya = "छ" and disabled_type = "पूर्ण अपाङ्गता (रातो)" then 1 else 0 end) as red_dis_male,
			
			sum(case when member_gender = "महिला" and disabled_parichaya = "छ" and disabled_type = "सामान्य अपाङ्गता (सेतो)" then 1 else 0 end) as whi_dis_female,
			sum(case when member_gender = "महिला" and disabled_parichaya = "छ" and disabled_type = "मध्यम अपाङ्गता (पहेलो)" then 1 else 0 end) as yell_dis_female,
			sum(case when member_gender = "महिला" and disabled_parichaya = "छ" and disabled_type = "अति अशक्त (निलो)" then 1 else 0 end) as blue_dis_female,
			sum(case when member_gender = "महिला" and disabled_parichaya = "छ" and disabled_type = "पूर्ण अपाङ्गता (रातो)" then 1 else 0 end) as red_dis_female,
	...
	public function household_by_roof_type(){
		$this->db->select('
			sum(case when house_roof_type like "%खर परालले छाएको%" then 1 else 0 end) as paral,
			sum(case when house_roof_type like "%जस्ताले छाएको%" then 1 else 0 end) as jasta,
			sum(case when house_roof_type like "%टायल वा ढुगाँले छाएको%" then 1 else 0 end) as tile,
			sum(case when house_roof_type like "%पक्कि ढलान%" then 1 else 0 end) as rcc,			
			sum(case when house_roof_type like "%काठले छाएको%" then 1 else 0 end) as wood,
			sum(case when house_roof_type like "%माटोले छाएको%" then 1 else 0 end) as mud,
			sum(case when house_roof_type like "%अन्य%" then 1 else 0 end) as others,
	...
	public function household_by_ownership_type(){
		$this->db->select('
			sum(case when living_basis_of_ownership_ like "%निजि%" then 1 else 0 end) as private,
			sum(case when living_basis_of_ownership_ like "%भाडामा%" then 1 else 0 end) as rent,
			sum(case when living_basis_of_ownership_ like "%संस्थागत%" then 1 else 0 end) as org,
			sum(case when living_basis_of_ownership_ like "%अन्य%" then 1 else 0 end) as oth,		
		');
		$this->db->from('household_statistics_form');
		$query = $this->db->get();
		return $query->result_array();	
	...
	public function household_by_drinking_water(){
		$this->db->select('
			sum(case when drinkingwater_collection_area like "%सार्वजनिक धारा (पाइप प्रणाली)%" then 1 else 0 end) as public,
			sum(case when drinkingwater_collection_area like "%निजिधारा (पाइप प्रणाली)%" then 1 else 0 end) as private,
			sum(case when drinkingwater_collection_area like "%ट्युवेल हेण्डपाइप%" then 1 else 0 end) as tubewell,
			sum(case when drinkingwater_collection_area like "%संरक्षित मुलको पानी वा ढाकिएको इनार कुवा%" then 1 else 0 end) as covered,	
			sum(case when drinkingwater_collection_area like "%नढाकिएको इनार कुवा असंरक्षित मूल%" then 1 else 0 end) as uncovered,
			sum(case when drinkingwater_collection_area like "%खोला वा नदीको पानी%" then 1 else 0 end) as river,	
			sum(case when drinkingwater_collection_area like "%मुलको पानी%" then 1 else 0 end) as mul,	
			sum(case when drinkingwater_collection_area like "%अन्य%" then 1 else 0 end) as others,
	...
	public function education_institution_info(){
		$this->db->select('
			sum(case when school_type like "%प्रा. वि%" and school_operation = "सरकारी" then 1 else 0 end) as primary_gov,
			sum(case when school_type like "%नि. मा. वि%" and school_operation = "सरकारी" then 1 else 0 end) as low_sec_gov,
			sum(case when school_type like "%मा.वि%" and school_operation = "सरकारी" then 1 else 0 end) as sec_gov,
			sum(case when school_type like "%उ. मा. वि%" and school_operation = "सरकारी" then 1 else 0 end) as higher_sec_gov,
			sum(case when school_type like "%अन्य%" and school_operation = "सरकारी" then 1 else 0 end) as others_gov,

			sum(case when school_type like "%प्रा. वि%" and school_operation = "सामुदायिक" then 1 else 0 end) as primary_samu,
			sum(case when school_type like "%नि. मा. वि%" and school_operation = "सामुदायिक" then 1 else 0 end) as low_sec_samu,
			sum(case when school_type like "%मा.वि%" and school_operation = "सामुदायिक" then 1 else 0 end) as sec_samu,
			sum(case when school_type like "%उ. मा. वि%" and school_operation = "सामुदायिक" then 1 else 0 end) as higher_sec_samu,
			sum(case when school_type like "%अन्य%" and school_operation = "सामुदायिक" then 1 else 0 end) as others_samu,

			sum(case when school_type like "%प्रा. वि%" and school_operation = "नीजी" then 1 else 0 end) as primary_pri,
			sum(case when school_type like "%नि. मा. वि%" and school_operation = "नीजी" then 1 else 0 end) as low_sec_pri,
			sum(case when school_type like "%मा. वि%" and school_operation = "नीजी" then 1 else 0 end) as sec_pri,
			sum(case when school_type like "%उ. मा. वि%" and school_operation = "नीजी" then 1 else 0 end) as higher_sec_pri,
			sum(case when school_type like "%अन्य%" and school_operation = "नीजी" then 1 else 0 end) as others_pri,

			');
		$this->db->from('sa-11sa');
		$query = $this->db->get();
		return $query->result_array();	
	}
	...
	public function university_or_college(){
		$this->db->select('*');
		$this->db->from('sa-11sa');
		$this->db->where('school_type like', '%उ. मा. वि%');
		$query = $this->db->get();
		return $query->result_array();	
	}

	public function primary_student_count_gov(){
		$this->db->select('sum(case when school_type like "%प्रा. वि%" and school_operation like "%सरकारी%" then female_std else 0 end) as primary_gov_female,
			sum(case when school_type like "%प्रा. वि%" and school_operation like "%सरकारी%" then male_std else 0 end) as primary_gov_male,

			sum(case when school_type like "%प्रा. वि%" and school_operation like "%नीजी%" then female_std else 0 end) as primary_pvt_female,
			sum(case when school_type like "%प्रा. वि%" and school_operation like "%नीजी%" then male_std else 0 end) as primary_pvt_male,

			sum(case when school_type like "%नि. मा. वि%" and school_operation like "%सरकारी%" then female_std else 0 end) as sec_gov_female,
			sum(case when school_type like "%नि. मा. वि%" and school_operation like "%सरकारी%" then male_std else 0 end) as sec_gov_male,

			sum(case when school_type like "%नि. मा. वि%" and school_operation like "%नीजी%" then female_std else 0 end) as sec_pvt_female,
			sum(case when school_type like "%नि. मा. वि%" and school_operation like "%नीजी%" then male_std else 0 end) as sec_pvt_male,

			sum(case when school_type like "%मा. वि%" and school_operation like "%सरकारी%" then female_std else 0 end) as gov_female,
			sum(case when school_type like "%मा. वि%" and school_operation like "%सरकारी%" then male_std else 0 end) as gov_male,

			sum(case when school_type like "%नि. मा. वि%" and school_operation like "%नीजी%" then female_std else 0 end) as pvt_female,
			sum(case when school_type like "%नि. मा. वि%" and school_operation like "%नीजी%" then male_std else 0 end) as pvt_male,		
			');
		$this->db->from('sa-11sa');
	...
	public function education_status_over_five(){
		$this->db->select('
			sum(case when education_status = "साक्षर" and member_gender = "पुरुष" then 1 else 0 end) as sakhxar,
			sum(case when education_status = "प्राथमिक शिक्षा" and member_gender = "पुरुष" then 1 else 0 end) as pri_edu,
			sum(case when education_status = "माध्यामिक शिक्षा" and member_gender = "पुरुष" then 1 else 0 end) as sec,
			sum(case when education_status = "नि. माध्यामिक शिक्षा" and member_gender = "पुरुष" then 1 else 0 end) as low_sec,
			sum(case when education_status = "उ मा वि " and member_gender = "पुरुष" then 1 else 0 end) as high_school,
			sum(case when education_status = "स्नातक" and member_gender = "पुरुष" then 1 else 0 end) as bach,
			sum(case when education_status = "स्नातकोत्तर" and member_gender = "पुरुष" then 1 else 0 end) as mast,
			sum(case when education_status = "अनौपचारिक शिक्षा" and member_gender = "पुरुष" then 1 else 0 end) as unoff,
			sum(case when member_gender = "पुरुष" then 1 else 0 end) as tot,

			sum(case when education_status = "साक्षर" and member_gender = "महिला" then 1 else 0 end) as sakhxar_fem,
			sum(case when education_status = "प्राथमिक शिक्षा" and member_gender = "महिला" then 1 else 0 end) as pri_edu_fem,
			sum(case when education_status = "माध्यामिक शिक्षा" and member_gender = "महिला" then 1 else 0 end) as sec_fem,
			sum(case when education_status = "नि. माध्यामिक शिक्षा" and member_gender = "महिला" then 1 else 0 end) as low_sec_fem,
			sum(case when education_status = "उ मा वि " and member_gender = "महिला" then 1 else 0 end) as high_school_fem,
			sum(case when education_status = "स्नातक" and member_gender = "महिला" then 1 else 0 end) as bach_fem,
			sum(case when education_status = "स्नातकोत्तर" and member_gender = "महिला" then 1 else 0 end) as mast_fem,
			sum(case when education_status = "अनौपचारिक शिक्षा" and member_gender = "महिला" then 1 else 0 end) as unoff_fem,
			sum(case when member_gender = "महिला" then 1 else 0 end) as tot_fem,
			');
		$this->db->from('member_info');
	...
	public function ward_wise_literacy_rate($ward = null){
		$this->db->select('count(id),
			sum(case when education_status != "निरक्षर" or education_status != " " and member_gender = "पुरुष" then 1 else 0 end) as male,
			sum(case when education_status != "निरक्षर" or education_status != " " and member_gender = "महिला" then 1 else 0 end) as female,
			
			sum(case when education_status != "निरक्षर" and education_status != " " then 1 else 0 end) as all_edu,
			');
		$this->db->from('member_info');
		// $this->db->join('personal_info_bibaran2', 'personal_info_bibaran2.id = member_info.primary_data_id');
		// $this->db->where('current_age >= 15');
		// $this->db->where('personal_info_bibaran2.ward_no', $ward);
		$query = $this->db->get();
		return $query->result_array();	
	}
	...
	public function health_post_info($ward){
		$this->db->select('sum(child_birth_in_healthpost),sum(four_type_preg_test),sum(vaccines_taken),
			sum(case when health_post_building like "%छ%" then 1 else 0 end) as building,
			sum(case when toilet_faci like "%छ%" then 1 else 0 end) as toilet,
			sum(std_female),sum(std_male),sum(hiv_female), sum(hiv_male)');
		$this->db->where('wada_no', $ward);
		$this->db->from('sa-16sa');
		$query = $this->db->get();
		return $query->result_array();
	}
// form not found
	...
	public function child_club(){
		$this->db->select('
			sum(case when bal_club = "छ" and school_operation = "सामुदायिक" then 1 else 0 end) as club,
			sum(case when school_operation = "सामुदायिक" then female_std else 0 end) as girls_count,
			sum(case when school_operation = "सामुदायिक" then male_std else 0 end) as boys_count,

			sum(case when bal_club = "छ" and school_operation = "नीजी" or school_operation = "सरकारी" then 1 else 0 end) as club_sch,
			sum(case when school_operation = "नीजी" or school_operation = "सरकारी" then female_std else 0 end) as girls_count_sch,
			sum(case when school_operation = "नीजी" or school_operation = "सरकारी" then male_std else 0 end) as boys_count_sch,
			');
		$this->db->from('sa-11sa');
		$query = $this->db->get();
		return $query->result_array();	
	...
	public function get_population_by_rojgari(){
		$this->db->select('
			sum(case when job_opportunity like "%सरकारी स्थायी%" then 1 else 0 end) as gov,
			sum(case when job_opportunity like "%सरकारी करार वा अस्थायी%" then 1 else 0 end) as gov_contract,
			sum(case when job_opportunity like "%अन्य निजी तथा गै स स%" then 1 else 0 end) as private,
			sum(case when job_opportunity like "%वेरोजगार%" then 1 else 0 end) as unemp,
			sum(case when job_opportunity like "%विद्यार्थी%" then 1 else 0 end) as student,
			sum(case when job_opportunity like "%नावालक%" then 1 else 0 end) as child,
			sum(case when job_opportunity like "%सेवा निवृत्त%" then 1 else 0 end) as retired
		');
		$this->db->from('member_info');
		$query = $this->db->get();
		return $query->result_array();	
	...
	public function unemployed_population(){
		$this->db->select('
			sum(case when job_opportunity = "वेरोजगार" and member_gender = "पुरुष" then 1 else 0 end) as unemp_male,
			sum(case when job_opportunity = "वेरोजगार" and member_gender = "महिला" then 1 else 0 end) as unemp_female,
			sum(case when job_opportunity = "वेरोजगार" and member_gender = "अन्य" then 1 else 0 end) as unemp_others,
			sum(case when job_opportunity = "वेरोजगार" then 1 else 0 end) as unemp_all,
			');
		$this->db->from('member_info');
		$query = $this->db->get();
		return $query->result_array();	
	...
	public function pasu_prod_info($ward){
		$this->db->select('
			sum(local_breed_cow_bull_count) as local_cow,
			sum(adv_breed_cow_bull_count) as adv_cow,
			sum(buffalo_count) as buff,
			sum(local_breed_sheep_count) as local_sheep,
			sum(adv_breed_sheep_count) as sheep,
			sum(pig_count) as pig,

			sum(chicken_duck_count) as duck,
			sum(bee_hive_count) as bee,
			sum(horse_khadchad_count) as horse,
			sum(other_domestic_animals_count) as others,
			');
		$this->db->where('ward_no', $ward);
		$this->db->from('household_statistics_form');
		$query = $this->db->get();
