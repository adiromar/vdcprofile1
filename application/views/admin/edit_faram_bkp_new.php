...
// $array = preg_grep("/^legend$/i", $nepali_title, PREG_GREP_INVERT);
// print_r($array);die;
...
<div class="row">
  <div class="col-md-12">
    <div class="tile">
      <div class="tile-body">
        <h4>Form Edit</h4>
        <?php echo form_open('admins/update_form', array('class' => '', 'id' => 'form')) ?>
...
<!-- New form question to add -->
      <div class="another mt-3" id="another" style="">
...
// alert(row);
    $('#another').append('<div class="app_div rownew' + x + '" id="another">\
      ...
      <input type="text" name="ufields[]" value="" class="form-control col-md-7" placeholder="Legend Name" required>\
      <input type="hidden" name="utypes[]" value="legend" class="form-control col-md-7">\
      <input type="hidden" name="unepali_title[]" value="legend" class="form-control col-md-7">\
      </div></div>\
          <div id="input'+x+'">\
...
var aa = 1;
  ...
  // alert(inp);
    $(i).append('<div class="form-inline mt-1 row' + aa + '">\
      <label class="control-label col-md-1">Field Name:</label>\
      <input type="text" class="form-control col-md-2" name="ufields[]" placeholder="in english" required>\
      <label class="control-label col-md-2">फिल्डको नाम:</label>\
      <input type="text" class="form-control col-md-2" name="unepali_title[]" required>\
      <label class="control-label col-md-2">Type:</label>\
      <select type="text" name="utypes[]" class="form-control col-md-2">\
      <option value="VARCHAR">VARCHAR</option><option value="INT">INT</option>\
...
// alert(box);
    ...
    $(box).append("<div class='form-inline mt-4 checkbox_wrapper"+chk+" rowb"+z+"'>\
      <label class='control-label col-md-1'>Field Name:</label><input type='text' class='form-control col-md-2' name='ufields[]' required>\
      <label class='control-label col-md-1'>फिल्डको नाम:</label>\
      <input type='text' class='form-control col-md-2' name='unepali_title[]'' required>\
      <input type='hidden' name='utypes[]' value='checkbox"+m+"'><label class='control-label col-md-1'>Checkbox Values:</label>\
      <input type='text' class='form-control col-md-2' name='uvalues[checkbox"+m+"][]' placeholder='Add Value'>\
    ...
    $(addcheckbox).click(function() {
      ...
      $(addMe).append("<input type='text' class='form-control col-md-2 offset-7' name='uvalues[checkbox"+m+"][]' placeholder='Add Value'><div id='addcheckbox"+ck+"'></div>");
      z++;
      chk++;
    });
// chk++;
...
// alert(rad);
  ...
  // alert(next);
    ...
    $(fiel).append("<div class='form-inline mt-4 field_wrapper"+next+" rowa"+y+"'>\
      <label class='control-label col-md-1'>Field Name:</label>\
      <input type='text' class='form-control col-md-2' name='ufields[]' required></input>\
      <label class='control-label col-md-1'>फिल्डको नाम:</label>\
      <input type='text' class='form-control col-md-2' name='unepali_title[]'' required>\
      <input type='hidden' name='utypes[]' value='radio"+p+"'>\
      <label class='control-label col-md-1'>Radio Values:</label>\
      <input type='text' class='form-control col-md-2' name='uvalues[radio"+p+"][]' placeholder='Add Value'>\
    ...
    $(addmore).click(function(){
      ...
      $(addTo).append("<input type='text' class='form-control col-md-2 offset-7' name='uvalues[radio"+p+"][]' placeholder='Add Value'><div id='addmore"+nxt+"'></div>");
      next++;
      y++;
    });
...
//Add dropdown
  ...
  $(adddrpdwn).click(function(){
    ...
    $(addcheckbox).click(function() {
      ...
      console.log(addMe);
      $(addMe).append("<input type='text' class='form-control col-md-2 offset-7' name='uvalues[dropdown"+t+"][]' placeholder='Add Value'><div id='addcheckbox"+cd+"'></div>");
      zz++;
      dd++;
    });
